...
# Used evenly_distribute to test positive and negative reviews evenly
...
with open('./output/svmsentiment_classifier.pkl', 'wb') as f:
    pickle.dump(clf, f)


#Opening to see if save went well
with open('./output/svmsentiment_classifier.pkl', 'rb') as f:
